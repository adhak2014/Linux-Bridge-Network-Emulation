...
echo ""
echo "Configure static multicast route 224.0.0.0 on h3 namespace"
ip netns exec h3 route add -net 224.0.0.0 netmask 240.0.0.0 h3-eth0
echo ""
echo "Show ip routing table on h3 namespace"
ip netns exec h3 ip route
echo ""
echo "Multicast addresses on h3 namespace"
ip netns exec h3 ip maddress show
echo ""
